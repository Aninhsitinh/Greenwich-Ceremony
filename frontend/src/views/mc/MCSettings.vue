    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
      <div class="flex flex-col md:flex-row items-center gap-8">
        ...
        <div class="relative group">
          <div class="w-32 h-32 rounded-full p-1 bg-gradient-to-tr from-purple-500 to-pink-600">
            <div 
        ...
        <div class="text-center md:text-left flex-1">
          ...
          <div class="flex flex-wrap justify-center md:justify-start gap-2">
            <span class="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-xs font-bold uppercase tracking-wider">
              {{ profile?.role || 'MC' }}
            </span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              type="text"
              required
              class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all"
            />
          </div>
          <div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200 dark:border-gray-700">
        ...
        <form v-else-if="passwordStep === 2" @submit.prevent="handleVerifyOTP" class="space-y-4">
           ...
           <input
              ...
              required
              maxlength="6"
              class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none font-mono text-xl text-center tracking-widest"
              placeholder="000000"
        ...
        <form v-else-if="passwordStep === 3" @submit.prevent="handleResetPassword" class="space-y-4">
           <div>
             ...
             <input 
               ...
               required
               minlength="6"
               class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none"
             />
           </div>
           <div>
...
const avatarStyle = computed(() => {
  ...
  return `background-image: url('https://ui-avatars.com/api/?name=${profile.value?.fullName || 'MC'}&background=a855f7&color=fff&size=200')`;
});
